	...
	public void confirmar (ActionEvent e)
	{
		...
		if (confirmacion.get() == ButtonType.OK)
		{
			...
			else
			{
				...
				String query3 = "INSERT INTO administrador (rut,id_cuenta,nombre) VALUES (?,?,?)";
				...
				try {
					...
					pst.setString(3, telefonoAdministrador.getText());
					...
					pst.setString(3, nombreAdministrador.getText());
